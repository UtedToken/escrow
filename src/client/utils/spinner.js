const getSpinElement = () => {
	...
	spinElement.setAttribute(
		'style',
		'color:white;font-size:15px;position:absolute;top:0;left:0;z-index:1000;width:100%;height:100%;background: rgba(255, 255, 255, 0.6);text-align: center;display:flex;justify-content:center;align-items: center;',
	)
